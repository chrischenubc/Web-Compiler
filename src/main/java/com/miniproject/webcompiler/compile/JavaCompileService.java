...
public class JavaCompileService implements CompileService{
    ...
    private static final String DEFAULT_JAVA_COMPILER_VERSION = "8";
     ...
     * @return '.class' file generated by the compiler
     */
    @Override
    public Resource compileWithCommand(String command, MultipartFile file) {
        ...
        if (!command.split(" ")[0].equals("javac")) {
    ...
    /**
     * Compile the source_code.java with 'javac --release version source_code.java'
     * @param version sets the programming language version for the compiler to compile the code
     *                  if version is not set by the user, use the DEFAULT_JAVA_COMPILER_VERSION
